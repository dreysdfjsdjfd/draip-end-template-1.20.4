...
public class EndGhostAttackGoal extends MeleeAttackGoal {
    private final EndGhostEntity entity;
    private int attackDelay = 15;
    private int ticksUntilNextAttack = 15;
    private boolean shouldCountTillNextAttack = false;

    public EndGhostAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((EndGhostEntity) mob);
    }
