...
public class EnderSnailModel<T extends EnderSnailEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData right_eye = body.addChild("right_eye", ModelPartBuilder.create(), ModelTransform.pivot(-0.8053F, -3.0734F, -4.6964F));

		ModelPartData cube_r2 = right_eye.addChild("cube_r2", ModelPartBuilder.create().uv(0, 3).cuboid(-0.5F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.1745F, 0.0F, -0.2618F));
		...
		ModelPartData cube_r3 = left_eye.addChild("cube_r3", ModelPartBuilder.create().uv(4, 3).cuboid(-0.5F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, -1.0F, 0.0F, 0.1745F, 0.0F, 0.2618F));
	...
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
		endersnail.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
	}
