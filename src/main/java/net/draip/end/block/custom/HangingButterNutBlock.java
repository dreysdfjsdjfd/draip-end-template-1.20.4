...
public class HangingButterNutBlock extends CaveVinesBodyBlock {
    public HangingButterNutBlock(Settings settings) {
        super(settings);
    }
    ...
    protected AbstractPlantStemBlock getStem() {
        return (AbstractPlantStemBlock) ModBlocks.HANGING_BUTTER_NUT_PLANT;
    }
