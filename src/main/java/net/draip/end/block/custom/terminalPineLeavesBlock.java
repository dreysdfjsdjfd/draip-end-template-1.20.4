...
public class terminalPineLeavesBlock extends LeavesBlock {
    public terminalPineLeavesBlock(Settings settings) {
        super(settings);
    }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        ParticleUtil.spawnParticle(world, pos, random, ModParticles.TERMINAL_LEAVES_PARTICLE);
    }
}
