...
public class windyMaplesLeavesBlock extends LeavesBlock {
    public windyMaplesLeavesBlock(Settings settings) {
        super(settings);
    }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        ParticleUtil.spawnParticle(world, pos, random, ModParticles.WINDY_LEAVES_PARTICLE);
    }
}
